    ...
    if (this.state.robots.length === 0) {
      ...
      return (
        <div className="tc">
          ...
          {/*(#6/video:#5) learn to wrap custom elements inside other custom elements
				Here: Scroll element wrapped around CardList element*/}
          {/*<Scroll defProp1={'test'} defProp2={'test2'}>*/}
          <Scroll>
